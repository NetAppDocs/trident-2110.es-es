...
== Novedades en 21.10.1

NetApp mejora y mejora continuamente sus productos y servicios. Estas son algunas de las últimas características y funcionalidades disponibles en Astra Trident.

Para las versiones anteriores, consulte https://docs.netapp.com/us-en/trident/earlier-versions.html["Versiones ealier de la documentación"].



=== Cambios desde Astra Trident 21.10.0
...
=== Cambios desde Astra Trident 21.07
